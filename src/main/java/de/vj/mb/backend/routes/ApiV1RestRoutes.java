...
public class ApiV1RestRoutes extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		this.rest("/api/v1").description("Meeting Barometer Backend")
				.consumes(MediaType.APPLICATION_JSON_VALUE)
				.produces(MediaType.APPLICATION_JSON_VALUE);

		this.rest("/api/v1/feedbacks/{meetingId}")
				.get("/").description("List all Feedbacks for Meeting").outType(Feedback[].class) //
